...
@Config(
    ...
    browser = Browser.FIREFOX, // the browser to use.
    hub = "http://192.168.99.100:4446/wd/hub" // you can specify a hub hostname / ip here.
)
...
//    private static final Logger logger = LogManager.getLogger(SampleFunctionalTest.class);
